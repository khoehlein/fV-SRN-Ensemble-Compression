...
folder = resolution.replace(':', '-') + f'_{core_channels.replace(":", "-")}_' + args['members'].replace(':', '-')

EXPERIMENT_NAME = 'ensemble/multi_grid/resampling/' + folder
...
PARAMETERS = {
    ...
    '--lossmode': 'density',
    '--network:core:layer-sizes': f'{core_channels}',
    ...
    '--network:latent-features:ensemble:num-channels': [32, 16, 8, 4],
