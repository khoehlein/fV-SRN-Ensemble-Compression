...
from experiments.retraining.multi_grid.model_loader import MultiGridModelLoader
...
def build_parser():
    ...
    MultiGridModelLoader.init_parser(parser)
...
def main():
    ...
    model_loader = MultiGridModelLoader.from_dict(args)
