...
class GUI(tk.Tk):
    ...
    def cropFromCurrent(self):
        ...
        # set text fields
        self.cropLeft.delete(0, tk.END);
        self.cropLeft.insert(0, str(cropLeft))
        self.cropBottom.delete(0, tk.END);
        self.cropBottom.insert(0, str(cropBottom))
        self.cropRight.delete(0, tk.END);
        self.cropRight.insert(0, str(cropRight))
        self.cropTop.delete(0, tk.END);
        self.cropTop.insert(0, str(cropTop))
        self.updateImage()
    ...
    def loadLenseSettings(self):
        ...
        with open(file, "r") as text_file:
            ...
            self.cropLeft.delete(0, tk.END);
            self.cropLeft.insert(0, settings.get('cropLeft', 0))
            self.cropBottom.delete(0, tk.END);
            self.cropBottom.insert(0, settings.get('cropBottom', 0))
            self.cropRight.delete(0, tk.END);
            self.cropRight.insert(0, settings.get('cropRight', 0))
            self.cropTop.delete(0, tk.END);
            self.cropTop.insert(0, settings.get('cropTop', 0))
    ...
    def processImage(self, imageIn: np.ndarray, hardCrop: bool):
        ...
        rect_ = cv.rectangle(image.copy(), (sourceStartY, sourceStartX), (sourceEndY, sourceEndX), color,
        ...
        image = cvToNp(cv.rectangle(image.copy(),
